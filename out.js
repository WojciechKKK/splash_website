...
module.exports = {"en":{"header":["login","about","teams","works","contact"],"login":["login","sign up","Email","password","repeat password","You do not have an account?","Get started!"],"about":"Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore eos molestias quod sint ipsum possimus temporibus officia iste perspiciatis consectetur in fugiat repudiandae cum. Totam cupiditate nostrum ut neque.","back":"x","teams":["Lorem ipsum dolor sit amet proint","Become part of our dream team!","Join us!"],"works":["our works","See all project"],"contact":["Give us a good news","Street Name & Number, Town, Postcode","+48 234 465 789","info@domain.com"],"form":["Your name","Your e-mail","Message","Send"]},"pl":{"header":["zaloguj","o nas","zespół","projekty","kontakt"],"login":["zaloguj","zarejstruj","Email","hasło","powtórz hasło","Nie masz jeszcze konta?","Załóż je!"],"about":"Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore eos molestias quod sint ipsum possimus temporibus officia iste perspiciatis consectetur in fugiat repudiandae cum. Totam cupiditate nostrum ut neque.","back":"x","teams":["Nasz zespół ekspertów","Bądź częścią naszego zespołu!","Dołącz do nas!"],"works":["nasze projekty","Zobacz wszystkie"],"contact":["Przekaż nam swoja opinię","Ulica & nr, Miasto, Kod pocztowy","+48 234 465 789","info@domena.pl"],"form":["Imię","Adres e-mail","Wiadomość","Wyślij"]}}
...
*/
var aa=__webpack_require__(3),ba=__webpack_require__(0),m=__webpack_require__(9),p=__webpack_require__(4),v=__webpack_require__(2),da=__webpack_require__(10),ea=__webpack_require__(11),fa=__webpack_require__(12),ha=__webpack_require__(5);
...
var Design = function (_Component) {
    ...
    function Design() {
        ...
        _this.componentDidMount = function () {
            ...
            allHeader.forEach(function (el, key) {
                if (key == 0) {
        ...
        _this.hideActuallyView = function () {
            setTimeout(function () {
                _this.setState({
                    actuallyView: !_this.state.actuallyView,
                    nameView: ''
        ...
        _this.state = {
            menu: _language2.default.en.header, //actually headers
...
var Logo = function (_Component) {
    ...
    function Logo() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Logo.__proto__ || Object.getPrototypeOf(Logo)).call.apply(_ref, [this].concat(args))), _this), _this.reload = function () {
            location.reload();
    ...
    _createClass(Logo, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "logo", onClick: this.reload },
                "splash ",
                _react2.default.createElement(
                    "a",
                    { className: "logoDot" },
...
var Language = function (_Component) {
    ...
    function Language() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Language.__proto__ || Object.getPrototypeOf(Language)).call.apply(_ref, [this].concat(args))), _this), _this.changeLanguage = function (e) {
            if (typeof _this.props.fnSetLang == 'function') {
                _this.props.fnSetLang(e.currentTarget.innerText);
                _this.setActiveClass(e);
            }
        }, _this.setActiveClass = function (e) {
    ...
    _createClass(Language, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'langText', onClick: this.changeLanguage, title: 'Zmie\u0144 j\u0119zyk PL' },
                    'pl'
                ),
                '|',
                _react2.default.createElement(
                    'div',
                    { className: 'langText langActive', onClick: this.changeLanguage, title: 'Change language EN' },
                    'en'
                )
            );
        }
...
var Header = function (_Component) {
    ...
    function Header() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Header.__proto__ || Object.getPrototypeOf(Header)).call.apply(_ref, [this].concat(args))), _this), _this.showOrHideElement = function (e) {
            if (typeof _this.props.fnClick == 'function') {
                _this.props.fnClick(e);
            }
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        null,
                        this.props.language == 'EN' ? _language2.default.en.header[this.props.id - 1] : _language2.default.pl.header[this.props.id - 1]
                    )
                )
            );
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { href: 'mailto:wojciech.kmiec@protonmail.com', title: 'send message' },
                        designBy
                    )
                ),
...
var ActuallyView = function (_Component) {
    ...
    function ActuallyView() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ActuallyView.__proto__ || Object.getPrototypeOf(ActuallyView)).call.apply(_ref, [this].concat(args))), _this), _this.hideAllHeaders = function () {
            ...
            //for UserLogin Comp
            var loginUserText = document.querySelector('.nameSubTitle');
    ...
    _createClass(ActuallyView, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_ButtonHide2.default, { fnShowheader: this.hideAllHeaders, text: finalText.back })
            );
        }
    }]);
...
var HeaderContact = function (_Component) {
    _inherits(HeaderContact, _Component);
...
var HeaderLogin = function (_Component) {
    ...
    function HeaderLogin() {
        ...
        _this.handlePasswordRepChange = function (e) {
            _this.setState({
    ...
    _createClass(HeaderLogin, [{
        ...
        value: function render() {
            var _state = this.state,
                info = _state.info,
                setSignUpDiv = _state.setSignUpDiv,
                setLoginDiv = _state.setLoginDiv,
                login = _state.login,
                usernameText = _state.usernameText,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { onClick: this.setSignUp, className: 'btnStart' },
                        text[6]
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'headerLoginInside' },
                    login ? _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { onClick: this.setLogin, className: 'loginHeadLogin ' + setLoginDiv },
                            text[0]
                        ),
                        _react2.default.createElement(
                            'div',
                            { onClick: this.setSignUp, className: 'loginHeadSign ' + setSignUpDiv },
                            text[1]
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement('input', { id: 'username', type: 'text', onChange: this.handleUsernameChange, value: usernameText, maxLength: 15, placeholder: 'name@gmail.com' }),
                            _react2.default.createElement(
                                'label',
                                { htmlFor: 'password' },
                                text[3]
                            ),
                            _react2.default.createElement('input', { id: 'password', type: 'password', onChange: this.handlePasswordChange, value: password, maxLength: 15, placeholder: 'Enter your password' }),
                            info == 'sign up' ? _react2.default.createElement(
                                ...
                                _react2.default.createElement('input', { id: 'password2', type: 'password', onChange: this.handlePasswordRepChange, value: passwordRepeat, placeholder: 'Repeat your password' })
                            ) : null
                        ),
                        _react2.default.createElement(
                            'button',
                            { className: 'loginSend', onClick: this.sendForm },
                            info == 'login' ? text[0] : text[1]
                        )
                    ),
                    login ? _react2.default.createElement(_UserLogin2.default, { language: this.props.language, name: usernameText }) : null
                )
            );
        }
    }]);
